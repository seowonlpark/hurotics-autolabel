...
per-rev held-out scores (each rev = one subject/day):
...
|---|---|---|---|---|
| 0.50 | 1.0000 | 0.9624 | 0.9241 (`rev5`) | 225 |
| 0.60 | 0.9796 | 0.9708 | 0.9371 (`rev5`) | 171 |
| 0.70 | 0.9490 | 0.9789 | 0.9433 (`rev5`) | 120 |
| 0.75 | 0.9283 | 0.9825 | 0.9568 (`rev5`) | 97 |
| 0.80 | 0.9084 | 0.9864 | 0.9635 (`rev5`) | 74 |
| 0.85 | 0.8800 | 0.9884 | 0.9699 (`rev5`) | 61 |
| 0.90 | 0.8307 | 0.9907 | 0.9695 (`rev5`) | 46 |
| 0.95 | 0.7294 | 0.9938 | 0.9813 (`rev5`) | 27 |
| 0.98 | 0.5974 | 0.9980 | 0.9890 (`rev5`) | 7 |
