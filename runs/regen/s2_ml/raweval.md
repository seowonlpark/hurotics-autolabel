...
**The lockbox is not in this table.** `rev8`'s four pairs are refused in code (§7), so every subject here is a development subject. Read this against `roweval_loro`'s 0.9901, not against rev8's 0.9269.
