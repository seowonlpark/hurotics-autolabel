...
|---|---|---|---|---|
| 0.50 | 1.0000 | 0.9555 | 0.8799 (`rev5`) | 55,357 |
| 0.60 | 0.9662 | 0.9682 | 0.8933 (`rev5`) | 38,215 |
| 0.70 | 0.9275 | 0.9784 | 0.9099 (`rev5`) | 24,916 |
| 0.75 | 0.9057 | 0.9824 | 0.9231 (`rev5`) | 19,865 |
| 0.80 | 0.8794 | 0.9866 | 0.9383 (`rev5`) | 14,676 |
| 0.85 | 0.8466 | 0.9901 | 0.9525 (`rev5`) | 10,391 |
| 0.90 | 0.7953 | 0.9942 | 0.9663 (`rev5`) | 5,727 |
| 0.95 | 0.6783 | 0.9980 | 0.9884 (`rev5`) | 1,650 |
| 0.98 | 0.5485 | 0.9994 | 0.9937 (`rev5`) | 390 |
...
|---|---|---|---|---|---|
| `off` | 0.8466 | 0.9901 | 0.9525 (`rev5`) | 10,391 | *(the baseline)* |
| `ceiling` | 0.8433 | 0.9906 | 0.9524 (`rev5`) | 9,811 | **-11 errors** at coverage 0.8427 (thr 0.8550) — better |
| `floor` | 0.9034 | 0.9839 | 0.9230 (`rev5`) | 18,125 | **-1,290 errors** at coverage 0.9034 (thr 0.7550) — better |
| `both` | 0.9001 | 0.9843 | 0.9228 (`rev5`) | 17,545 | **-1,133 errors** at coverage 0.9007 (thr 0.7600) — better |
