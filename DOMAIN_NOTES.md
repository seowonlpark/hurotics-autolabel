...
First live `s4_fusion` run (`runs/2026-07-22_run3`, 6 findings, all provenance-gated, $1.41). It
...
**Now built (`stages/s4_fusion/newclass.py` + `agents/s4_newclass.py`, `s4_newclass` step).** The
